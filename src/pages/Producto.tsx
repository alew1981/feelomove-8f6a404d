...
const Producto = ({ slugProp }: ProductoProps) => {
  ...
  // Title ES: "Entradas Bruno Mars Madrid — 10 Jul | Desde 65€ + Hotel"
  // Title EN: "Bruno Mars Madrid Tickets — Jul 10 | From 65€ + Hotel"
  ...
  // Description con fecha completa y precio
